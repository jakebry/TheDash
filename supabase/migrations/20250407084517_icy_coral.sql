/*
  ...
  1. Changes
    ...
    - Fix force_jwt_refresh function by properly dropping it first
...
-- Drop the existing force_jwt_refresh function first
DROP FUNCTION IF EXISTS force_jwt_refresh();
